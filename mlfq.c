    ...
    while(timesofar[ind] < cputime[ind])
    {
        ...
        switch(level[ind])
        {
            case Q0:
            {
                ...
                int var;
                for(var=q2->front; var!=q2->rear; var = (var+1)%n)
                {
                    if(q2->items[var]==ind+1)
                    {
                        break;
                    }
                }
                if(q2->items[q2->rear]==ind+1)
                {
                    var = q2->rear;
                }
                for(; var!=q2->front; var = (var+4)%n)
                {
                    if(q2->items[(var+4)%n]<=q2->items[var])
                    {
                        break;
                    }
                    int temp = q2->items[(var+4)%n];
                    q2->items[(var+4)%n] = q2->items[var];
                    q2->items[var] = temp;
                }
                break;
            }
